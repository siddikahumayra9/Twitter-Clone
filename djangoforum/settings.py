...
SECRET_KEY = 'django-insecure-og#17%ah!)s_9oadqm!n3va*(!fvalu39v_v9y=-xqm58bo#4@'
...
cloudinary.config(
    cloud_name="dc7iu3hpl",
    api_key="655326515244351",
    api_secret="AhkJFWl8FVkUCBpNF-CHRhoTwHg",
)